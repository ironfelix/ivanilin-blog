...
У Майка есть долговременная память. Не как у чат-бота «запомни контекст на 10 сообщений», а полноценная:

- **MEMORY** — что знает обо мне и проектах: предпочтения, контакты, текущие задачи паста-бара, KPI бизнесов. Выжимка самого важного.
- **Профиль** — мои характеристики: рост, вес, цели по КБЖУ, добавки, лекарства.
- **Скиллы** — процедурная память. Например скилл «анализ еды» знает как считать калорийность по фото. «Деплой блога» — как собрать Astro и запушить на GitHub Pages.
...
| Кира | Пятница 10:00 | Пятничное расписание |
