...
![Архитектура ассистента: интерфейсы, ядро Hermes на vps, долговременная память, слой моделей, внешние источники](/hermes-arch-v2.svg)
...
Итог: простой вопрос занимает около шести секунд вместо пятнадцати. Не мгновенно, обещать здесь одну секунду было бы враньём.
